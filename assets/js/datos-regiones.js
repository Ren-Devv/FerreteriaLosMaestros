/**
 * Estructura: array de objetos { region: string, comunas: string[] }
 * Se expone como variable global REGIONES_CHILE (sin módulos, para
 * mantener consistencia con el resto del proyecto en JS vanilla).
 */
